...
public class Search {
	...
	public void setShipManagement(String shipManagement) {
		this.shipManagement = shipManagement;
	}
	////////추가
	...
	public String toString() {
		return "Search [currentPage=" + currentPage + ", searchCondition=" + searchCondition + ", sortCondition="
				+ sortCondition + ", shipManagement=" + shipManagement + ", searchKeyword=" + searchKeyword
